...
export default function Component() {
  const backgroundStyle: React.CSSProperties = {
    backgroundImage: `url('/r5.png')`, // Change image as needed
            ...
            <div className="flex items-center gap-4">
              <div>
                ...
                <p className="text-white">
                  Experience the finest cuisine with a touch of elegance. Enjoy
                  gourmet dishes crafted to perfection with fresh, high-quality ingredients.
                </p>
            ...
            <div className="grid gap-8">
              <Card className="p-6 rounded-lg shadow-lg">
                <Review
                  ...
                  numFilledStars={5}
                  rating={5}
                  reviewText="An exceptional dining experience. The truffle risotto was divine, and the service was impeccable. Highly recommended for a special occasion."
                  numHelpful={24}
                />
              </Card>
              <Card className="p-6 rounded-lg shadow-lg">
                <Review
                  ...
                  numFilledStars={4}
                  rating={4}
                  reviewText="The ambiance was elegant and the food was great. The lobster bisque was a highlight. A bit pricey, but worth the experience."
                  numHelpful={20}
                />
              </Card>
              <Card className="p-6 rounded-lg shadow-lg">
                <Review
                  ...
                  numFilledStars={3}
                  rating={3}
                  reviewText="Good food, but the service was a bit slow. The steak was cooked well, but the sides were underwhelming."
                  numHelpful={15}
                />
              </Card>
            </div>
